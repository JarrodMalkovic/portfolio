			...
			<Container>
				<div className="space-y-4 md:space-y-10">
					<div className="space-y-2 md:space-y-4">
						...
						<Text>
							I&lsquo;m a dedicated software engineer based in Sydney 🇦🇺 who loves incorporating a
							bit of emoji fun into my work 💻. I thrive on crafting elegant solutions to complex
							problems, always with an eye for efficient and scalable code. 👨‍💻
						</Text>
					</div>
					<div className="space-y-2 md:space-y-4">
